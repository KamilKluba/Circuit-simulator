...
public abstract class Gate extends Component {
    ...
    public void move(double x, double y, double mousePressX, double mousePressY){
        ...
        for(int i = 0; i < arrayArrayListLines.length; i++) {
            for (Line l : arrayArrayListLines[i]) {
                changePointCoordinates(l, x, y, mousePressX, mousePressY, arrayArrayListLines.length, i);
            }
        }
        for(Line l : arrayListLinesOutput) {
            changePointOutputCoordinates(l, x, y, mousePressX, mousePressY);
        }
    }

    private void changePointCoordinates(Line l, double x, double y, double mousePressX, double mousePressY, int listsAmount, int listNumber){
        if (l != null) {
            if (l.getComponent1() != null && l.getComponent1().equals(this)) {
    ...
    private void changePointOutputCoordinates(Line l, double x, double y, double mousePressX, double mousePressY){
        if (l != null) {
            if (l.getComponent1() != null && l.getComponent1().equals(this)) {
                l.setX1(l.getX1() + x - mousePressX);
                l.setY1(l.getY1() + y - mousePressY);
