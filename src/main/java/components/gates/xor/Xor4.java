...
public class Xor4 extends Xor implements Serializable {
    private static final long serialVersionUID = 180000000000L;

    public Xor4(double x, double y, boolean startLife, XYChart.Series<Long, String> series, Long chartMillisCounter){
