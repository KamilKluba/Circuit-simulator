...
public class Xnor4 extends Xnor implements Serializable {
    private static final long serialVersionUID = 10503000000L;

    public Xnor4(double x, double y, boolean startLife, XYChart.Series<Long, String> series, Long chartMillisCounter){
